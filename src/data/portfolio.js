...
export const about = [
  "Final-year Informatics student bridging the gap between high-performance infrastructure and advanced machine learning.",
  "I specialize in designing scalable, cloud-native architectures on AWS and GCP, while simultaneously collaborating on deep learning research for climate science and massive data processing."
];
...
export const experience = [
  {
    ...
    description: "Designed scalable AWS serverless architectures and real-time Amazon MSK pipelines for 300k+ retailers."
  },
  {
    date: "Jan 2025 - May 2025",
    role: "Information Technology Intern",
    company: "UBS Gold",
    description: "Developed ML forecasting algorithms and deployed Docker-based applications."
  },
  {
    date: "Feb 2024 - Dec 2025",
    role: "Cloud & DevOps Engineer",
    company: "BETA U",
    description: "Implemented CI/CD pipelines and NGINX load balancing."
  }
];
